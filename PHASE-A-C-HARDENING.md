...
> ⚠️ ПЕРЕ-СКОУП (Damir): СЕЙЧАС НЕ продакшен. **ОТЛОЖЕНО:** Мина #1 платёж/биллинг + Фаза D масштаб(10k).
> ФОКУС: чистая структура (strangler) + качество фич. Мина #0 — дешёвая гигиена, не блокер.
...
### #1 Бизнес — RU-платёж  ⏸️ ОТЛОЖЕНО (не продакшен сейчас — не трогать)
