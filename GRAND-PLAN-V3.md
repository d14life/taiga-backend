...
- [x] BATCH 16 — /sprint self-test (S+builtins) + frontend unit tests (vitest: decision/rag/money/usage-log) + tool-card polish + changelog depth — DONE (FE 2b55637 / parent next)
