...
ФИЧИ — ГЛАВНЫЙ источник = docs/design/FEATURE-LEDGER.md (САМЫЙ свежий, 17 июн: 139 фич по 13
категориям, собран 13 агентами по всему 100ч-чату, [GAP]=восстановленные) + docs/design/GAPS-RECOVERED.md.
Дополнительно: FEATURE-INVENTORY.md (184 буллета) и self_manifest() в server.py (живой список,
который рендерит App Store / feature-catalog.tsx). СВЕРКА в фазе ПОНИМАНИЕ: объедини LEDGER +
INVENTORY + self_manifest + видимое на 32 панелях + 90 flow + 48 скринах → единый чек-лист, ничего
не потерять (включая скрытые из feature-store).

АВТОНОМИЯ: решай сам где можешь (бери широкую авторизацию), буди меня ТОЛЬКО на реально важных
развилках (продукт/прайс/название фич/деньги). Технические решения — сам. Не сыпь мелкими вопросами.
