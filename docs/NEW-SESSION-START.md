...
Ничего из ~184 фич не потерять. СВЕРКА: в фазе ПОНИМАНИЕ пройди FEATURE-INVENTORY против ВСЕХ
32 панелей usertest-jun15 + 90 flow-скринов + 48 docs/screenshots — что ВИДНО на экранах, но
НЕТ в инвентаре, допиши в инвентарь. Не потерять ни одной (включая скрытые из feature-store).
