...
- **ВНЕШНИЙ КРИТИК (другой взгляд + живой веб).** Чтобы Claude не судил сам себя — на важных шестерёнках
  зови `python3 tools/external-critique.py "<фича/решение/claim>"`: живой Google-веб (Serper, из РФ напрямую)
  + НЕ-Claude модель (NVIDIA deepseek), Gemini 2.5 + Google-grounding через туннель :1080 как бонус. Даёт
  внешнюю перспективу + сверку с индустрией/best-practices. Ключи — ~/.reel-intelligence.env.
